...
public class CallLinksTest extends CallTestBase {
    ...
    public void testConnectWithNoResponse() throws Exception {
        ...
        GroupCall call = callManager.createCallLinkCall("sfu.example", null, new byte[] { 1, 2, 3 }, EXAMPLE_KEY, null, new byte[] {}, null, CallManager.AudioProcessingMethod.Default, false, callObserver);
